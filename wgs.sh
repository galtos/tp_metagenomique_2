...
dossier_reads_bruts=fastq #$1
dossier_sortie=output #$2
...
for file in $(ls $dossier_reads_bruts/EchG_R1.fastq.gz);do
    ...
    ./soft/blastn -db databases/resfinder.fna -query $dossier_sortie/predit/genes_full.fna -evalue 1E-3 -perc_identity 80 -qcov_hsp_perc 80 -out $dossier_sortie/predit/genes_annotes.out -outfmt 6 -culling_limit 2
done

#resistance pour des antibiotiques tels que beta lactamase, aminogglycosides etc ...
